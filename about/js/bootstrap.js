...
(function (global, factory) {
  ...
  var Button =
    ...
    (function () {
      ...
      _proto.toggle = function toggle() {
        ...
        if (rootElement) {
          ...
          if (input) {
            if (input.type === "radio") {
              if (
                input.checked &&
                this._element.classList.contains(ClassName$1.active5)
              ) {
                ...
                if (activeElement) {
                  $(activeElement).removeClass(ClassName$1.active5);
                }
              }
            }
        ...
        if (triggerChangeEvent) {
          $(this._element).toggleClass(ClassName$1.active5);
        }
      };
  ...
  var Selector$2 = {
    ACTIVE: ".active5",
    ACTIVE_ITEM: ".active5.carousel-item",
    ITEM: ".carousel-item",
    ...
    (function () {
      ...
      _proto._triggerSlideEvent = function _triggerSlideEvent(
        ...
        var fromIndex = this._getItemIndex(
          this._element.querySelector(Selector$2.active5_ITEM)
        );
      ...
      _proto._setActiveIndicatorElement = function _setActiveIndicatorElement(
        ...
        if (this._indicatorsElement) {
          var indicators = [].slice.call(
            this._indicatorsElement.querySelectorAll(Selector$2.active5)
          );
          $(indicators).removeClass(ClassName$2.active5);

          var nextIndicator =
            this._indicatorsElement.children[this._getItemIndex(element)];

          if (nextIndicator) {
            $(nextIndicator).addClass(ClassName$2.active5);
          }
        }
      };
      ...
      _proto._slide = function _slide(direction, element) {
        ...
        if (nextElement && $(nextElement).hasClass(ClassName$2.active5)) {
          this._isSliding = false;
          return;
        }
        ...
        if ($(this._element).hasClass(ClassName$2.SLIDE)) {
          ...
          $(activeElement).removeClass(ClassName$2.active5);
          $(nextElement).addClass(ClassName$2.active5);
          this._isSliding = false;
  ...
  var Collapse =
    ...
    (function () {
      ...
      _proto.show = function show() {
        ...
        if (this._parent) {
          actives = [].slice
            .call(this._parent.querySelectorAll(Selector$3.active5S))
  ...
  var DefaultType$4 = {
    ...
    offset: "(number|string|function)",
    container5: "(string|element|boolean)",
    ...
    (function () {
      ...
      _proto.show = function show() {
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          var container5 = this._getcontainer5();
      ...
      _proto._getcontainer5 = function _getcontainer5() {
        if (this.config.container5 === false) {
          return document.body;
        }

        if (Util.isElement(this.config.container5)) {
          return $(this.config.container5);
        }

        return $(document).find(this.config.container5);
      };
      ...
      _proto._activate = function _activate(target) {
        ...
        if ($link.hasClass(ClassName$8.DROPDOWN_ITEM)) {
          $link
            ...
            .addClass(ClassName$8.active5);
          $link.addClass(ClassName$8.active5);
        } else {
          // Set triggered link as active
          $link.addClass(ClassName$8.active5); // Set triggered links parents as active
          // With both <ul> and <nav> markup a parent is the previous sibling of any nav ancestor

          $link
            .parents(Selector$8.NAV_LIST_GROUP)
            .prev(Selector$8.NAV_LINKS + ", " + Selector$8.LIST_ITEMS)
            .addClass(ClassName$8.active5); // Handle special case when .nav-link is inside .nav-item
      ...
      _proto._clear = function _clear() {
        [].slice
          ...
          .filter(function (node) {
            return node.classList.contains(ClassName$8.active5);
          })
          .forEach(function (node) {
            return node.classList.remove(ClassName$8.active5);
          });
      }; // Static
  ...
  var Selector$9 = {
    ...
    NAV_LIST_GROUP: ".nav, .list-group",
    ACTIVE: ".active5",
    ACTIVE_UL: "> li > .active5",
    DATA_TOGGLE:
      '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]',
    DROPDOWN_TOGGLE: ".dropdown-toggle",
    DROPDOWN_ACTIVE_CHILD: "> .dropdown-menu .active5",
    /**
     * ------------------------------------------------------------------------
     * Class Definition
     * ------------------------------------------------------------------------
    ...
    (function () {
      ...
      _proto.show = function show() {
        ...
        if (
          (this._element.parentNode &&
            this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
            $(this._element).hasClass(ClassName$9.active5)) ||
      ...
      _proto._activate = function _activate(element, container5, callback) {
        var _this2 = this;

        var activeElements =
          container5 &&
          (container5.nodeName === "UL" || container5.nodeName === "OL")
            ? $(container5).find(Selector$9.active5_UL)
            : $(container5).children(Selector$9.active5);
      ...
      _proto._transitionComplete = function _transitionComplete(
        ...
        if (active) {
          $(active).removeClass(ClassName$9.active5);
          var dropdownChild = $(active.parentNode).find(
            Selector$9.DROPDOWN_ACTIVE_CHILD
          )[0];

          if (dropdownChild) {
            $(dropdownChild).removeClass(ClassName$9.active5);
          }
        ...
        $(element).addClass(ClassName$9.active5);
        ...
        if (
          ...
          if (dropdownElement) {
            ...
            $(dropdownToggleList).addClass(ClassName$9.active5);
          }
